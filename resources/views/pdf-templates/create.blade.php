                        ...
                        <form action="{{ route('pdf-templates.store') }}" method="POST">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('page_size') is-invalid @enderror" id="page_size"
                                            ...
                                            <option value="A4" {{ old('page_size') == 'A4' ? 'selected' : '' }}>A4
                                            </option>
                                            <option value="A3" {{ old('page_size') == 'A3' ? 'selected' : '' }}>A3
                                            </option>
                                            <option value="Letter" {{ old('page_size') == 'Letter' ? 'selected' : '' }}>
                                                Letter</option>
                                            <option value="Legal" {{ old('page_size') == 'Legal' ? 'selected' : '' }}>
                                                Legal</option>
                                        </select>
                                        @error('page_size')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('margin_right', 20) }}" min="0"
                                            required>
                                        @error('margin_right')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('margin_bottom', 20) }}" min="0"
                                            required>
                                        @error('margin_bottom')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            name="margin_left" value="{{ old('margin_left', 20) }}"
                                            min="0" required>
                                        @error('margin_left')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('header_html') is-invalid @enderror" id="header_html" name="header_html"
                                    rows="3" placeholder="Optional header content">{{ old('header_html') }}</textarea>
                                @error('header_html')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h6 class="mb-0">
                                        <i class="fas fa-info-circle"></i> Quick Placeholder Reference
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('footer_html') is-invalid @enderror" id="footer_html" name="footer_html"
                                    rows="3" placeholder="Optional footer content">{{ old('footer_html') }}</textarea>
                                @error('footer_html')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
